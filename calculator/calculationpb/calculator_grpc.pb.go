...
func (c *calculationServiceClient) Calculate(ctx context.Context, in *CalculationRequest, opts ...grpc.CallOption) (*CalculationResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/calculation.CalculationService/Calculate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedCalculationServiceServer) Calculate(context.Context, *CalculationRequest) (*CalculationResponse, error) {
...
func _CalculationService_Calculate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/calculation.CalculationService/Calculate",
	}
